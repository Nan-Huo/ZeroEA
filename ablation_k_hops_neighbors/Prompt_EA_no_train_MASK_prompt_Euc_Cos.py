...
target_embed_1, c_list_1, entity_text_left, entity_embed_left = get_target_embed('text_input_no_train_11_wxt_KI.txt', tokenizer, model)
target_embed_2, c_list_2, entity_text_right, entity_embed_right = get_target_embed('text_input_no_train_22_wxt_KI.txt', tokenizer, model)
