...
def multi_hop(head_node_id, ent_ids, rel_ids, nodes):
    ## +1 hop
    text_all = []
...
#     ent_l_text = ent_ids[entity_id].strip()
    ...
    for char_set in text_id_l:
        ...
        two_hop_txt_all = multi_hop(content[1], ent_ids, rel_ids, nodes)
...
with open("ill_ent_ids", "r") as GT_file:
    ...
    for line in GT_file:
        ...
        if counter % 20 == 0:
            text_save("text_input_no_train_11_wxt_KI_2hop_3000.txt", text_input_all_1)
            text_save("text_input_no_train_22_wxt_KI_2hop_3000.txt", text_input_all_2)
