...
#             if num_hops == 3:
#                 for neighbor_2hop in hop_2_neighbor_list:
#                     node_3_hop_neighbor_list_degree_i, all_hop_neighbor_list_degree, _ = node_degree(neighbor_2hop, nodes_tmp_2, decay_factor, hop_1_neighbor_list_new, all_hop_neighbor_list_degree, KG2, 3)
#                     all_hop_neighbor_list_degree.extend(node_3_hop_neighbor_list_degree_i)
...
with open("ill_ent_ids", "r") as GT_file:
    ...
    for line in GT_file:
        ...
        if counter % 20 == 0:
            text_save("data/text_input_no_train_11_wxt_"+str(sys.argv[2])+"_hop_degree_KI_"+str(sys.argv[1])+".txt", text_input_all_1)
            text_save("data/text_input_no_train_22_wxt_"+str(sys.argv[2])+"_hop_degree_KI_"+str(sys.argv[1])+".txt", text_input_all_2)
