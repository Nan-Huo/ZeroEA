...
thresh_num = 15000
template_fn_1 = sys.argv[1]
template_fn_2 = sys.argv[2]
...
target_embed_1, c_list_1, entity_text_left, entity_embed_left = get_target_embed('data/' + template_fn_1, tokenizer, model)
target_embed_2, c_list_2, entity_text_right, entity_embed_right = get_target_embed('data/' + template_fn_2, tokenizer, model)
