...
with open("ill_ent_ids", "r") as GT_file:
    ...
    for line in GT_file:
        ...
        if counter % 20 == 0:
            text_save("data/text_input_no_train_11_wxt_2hop_motif_"+str(sys.argv[1])+".txt", text_input_all_1)
            text_save("data/text_input_no_train_22_wxt_2hop_motif_"+str(sys.argv[1])+".txt", text_input_all_2)
