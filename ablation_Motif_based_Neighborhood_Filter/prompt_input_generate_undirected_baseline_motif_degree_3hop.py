...
with open("ill_ent_ids", "r") as GT_file:
    ...
    for line in GT_file:
        ...
        if counter % 20 == 0:
            text_save("data/text_input_no_train_11_wxt_"+str(sys.argv[2])+"_hop_motif_degree_"+str(sys.argv[1])+".txt", text_input_all_1)
            text_save("data/text_input_no_train_22_wxt_"+str(sys.argv[2])+"_hop_motif_degree_"+str(sys.argv[1])+".txt", text_input_all_2)
