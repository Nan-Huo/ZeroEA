...
python3 ZeroEA_input_generate_undirected  ../data/DBP15K/zh_en/ text_input_no_train_11_wxt.txt text_input_no_train_22_wxt.txt False # you can change the data dir; input file dirs; WebSearch use flag as you like
...
python3 ZeroEA_input_generate_undirected  ../data/DBP15K/zh_en/ text_input_no_train_11_wxt_KI.txt text_input_no_train_22_wxt_KI.txt True # you can change the data dir; input file dirs; WebSearch use flag as you like
